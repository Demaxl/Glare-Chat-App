...
# Read default env file first
env.read_env(BASE_DIR / ".env.dist")

# if not TESTING:
# Read custom local env file if it exists
...
GOOGLE_OAUTH_RAW_REDIRECT_URI = env('GOOGLE_OAUTH_RAW_REDIRECT_URI')
